...
public class BluetoothHandlerService extends Service {
    ...
    private static final String DEVICE_NAME = "SmartCycle";
            ...
            if (btAdapter.isEnabled()) {
                ...
                try {
                    ...
                    if(pairedDevices.size() > 0)
                    {
                        ...
                        {
                            if(mdevice.getName().equals(DEVICE_NAME))
                            {
                                device = mdevice;
                                break;
                            }
                    ...
                    Log.d("DEBUG BT", "ATTEMPTING TO CONNECT TO REMOTE DEVICE : " + DEVICE_NAME);
    ...
    private class ConnectingThread extends Thread {
        ...
        ConnectingThread(BluetoothDevice device) {
            ...
            Log.d("DEBUG BT", "DEVICE NAME : " + DEVICE_NAME);
